...
-- 2. Find the count of new customers acquired everyday from the launch date.
...
-- 4. List all the customers with no order in the last 7 days but were acquired one month ago with their order on promo
...
-- 6. List the customers who placed more than 1 order and all their orders are on a promo only.
